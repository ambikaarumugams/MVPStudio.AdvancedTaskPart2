...
Scenario: Validate that the user can't update the shared skill with invalid skill exchange tags
	When I update the shared skill skill exchange tags with invalid input from the json file "ManageListingsEdit_InvalidSkillExchangeTags.json"
	Then the skills shouldn't be updated successfully

Scenario: Validate that the user can't update the shared skill with invalid tags
	When I update the shared skill tags with invalid input from the json file "ManageListingsEdit_InvalidTags.json"
	Then the skills shouldn't be updated successfully

Scenario: Validate that the user can't update the shared skill with leave either one or all the fields empty
	When I update the shared skill tags with with leave either one or all the fields empty from the json file "ManageListingsEdit_LeavingEitherOneOrAllTheFieldsAreEmpty.json"
	Then the skills shouldn't be updated successfully